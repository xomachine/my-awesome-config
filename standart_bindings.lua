...
local globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control", "Shift" }, "j", function () client.focus:move_to_screen() end,
              {description = "move client to the next screen", group = "screen"}),
    awful.key({ modkey, "Control", "Shift" }, "k", function () client.focus:move_to_screen(client.focus.screen.index-1) end,
              {description = "move client the previous screen", group = "screen"}),
